...
#-------------------------------------------------------------------------
# Generated: /afs/ece.cmu.edu/usr/edubbers/private/research_work/my_mflowgen/mflowgen/mflowgen/assertions/assertion_helpers.py
...
def main():
  ...
  print()
  print( GREEN + '    > Checking preconditions for step "synopsys-ptpx-genlibdb"' + END )
  print()
