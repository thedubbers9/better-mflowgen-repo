...
#  Created by Genus(TM) Synthesis Solution 18.14-s037_1 on Tue Apr 22 11:08:54 EDT 2025
...
current_design LeftShift_16_flopped

create_clock -name "ideal_clock" -period 10.0 -waveform {0.0 5.0} [get_ports clk]
set_load -pin_load 7.0 [get_ports {result_flopped[15]}]
set_load -pin_load 7.0 [get_ports {result_flopped[14]}]
set_load -pin_load 7.0 [get_ports {result_flopped[13]}]
set_load -pin_load 7.0 [get_ports {result_flopped[12]}]
set_load -pin_load 7.0 [get_ports {result_flopped[11]}]
set_load -pin_load 7.0 [get_ports {result_flopped[10]}]
set_load -pin_load 7.0 [get_ports {result_flopped[9]}]
set_load -pin_load 7.0 [get_ports {result_flopped[8]}]
set_load -pin_load 7.0 [get_ports {result_flopped[7]}]
set_load -pin_load 7.0 [get_ports {result_flopped[6]}]
set_load -pin_load 7.0 [get_ports {result_flopped[5]}]
set_load -pin_load 7.0 [get_ports {result_flopped[4]}]
set_load -pin_load 7.0 [get_ports {result_flopped[3]}]
set_load -pin_load 7.0 [get_ports {result_flopped[2]}]
set_load -pin_load 7.0 [get_ports {result_flopped[1]}]
set_load -pin_load 7.0 [get_ports {result_flopped[0]}]
...
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[15]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[14]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[13]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[12]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[11]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[10]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[9]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[8]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[7]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[6]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[5]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[4]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[3]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[2]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[1]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result_flopped[0]}]
