...
###########################################################
if {[::legacy::find -design /designs/LeftShift_16_flopped] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/LeftShift_16_flopped
}
...
# Design
###########################################################
read_netlist -top LeftShift_16_flopped results_syn/syn_out.v
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/LeftShift_16_flopped]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/LeftShift_16_flopped]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/LeftShift_16_flopped]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/LeftShift_16_flopped]
