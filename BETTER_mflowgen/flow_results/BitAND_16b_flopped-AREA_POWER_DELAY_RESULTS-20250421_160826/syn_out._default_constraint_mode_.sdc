...
#  Created by Genus(TM) Synthesis Solution 18.14-s037_1 on Mon Apr 21 15:50:21 EDT 2025
...
current_design BitAND_16b_flopped

create_clock -name "ideal_clock" -period 10.0 -waveform {0.0 5.0} [get_ports clk]
set_load -pin_load 7.0 [get_ports {result[15]}]
set_load -pin_load 7.0 [get_ports {result[14]}]
set_load -pin_load 7.0 [get_ports {result[13]}]
set_load -pin_load 7.0 [get_ports {result[12]}]
set_load -pin_load 7.0 [get_ports {result[11]}]
set_load -pin_load 7.0 [get_ports {result[10]}]
set_load -pin_load 7.0 [get_ports {result[9]}]
set_load -pin_load 7.0 [get_ports {result[8]}]
set_load -pin_load 7.0 [get_ports {result[7]}]
set_load -pin_load 7.0 [get_ports {result[6]}]
set_load -pin_load 7.0 [get_ports {result[5]}]
set_load -pin_load 7.0 [get_ports {result[4]}]
set_load -pin_load 7.0 [get_ports {result[3]}]
set_load -pin_load 7.0 [get_ports {result[2]}]
set_load -pin_load 7.0 [get_ports {result[1]}]
set_load -pin_load 7.0 [get_ports {result[0]}]
...
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[15]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[14]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[13]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[12]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[11]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[10]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[9]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[8]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[7]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[6]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[5]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[4]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[3]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[2]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[1]}]
set_output_delay -clock [get_clocks ideal_clock] -add_delay 0.0 [get_ports {result[0]}]
