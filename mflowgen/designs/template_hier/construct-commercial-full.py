...
def construct():
  ...
  adk_name = 'PARAM_PDK_NAME'
  adk_view = 'view-standard'

  parameters = {
    'construct_path' : __file__,
    'design_name'    : 'PARAM_DESIGN_NAME_1',
    'clock_period'   : PARAM_CLOCK_PERIOD,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    'topographical'  : True,
  ...
  g.connect( rtl.o('PARAM_DESIGN_NAME_2.sv'), verif_post_synth.i('design.ref.v') )
